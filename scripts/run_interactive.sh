...
./bin/ysceneitraces outs/extra1/extra1.json -o out/uniformed_points.jpg -s 256 -r 720

./bin/yscenegen tests/extra2/extra2.json -o outs/extra2/extra2.json --extra2 object

./bin/ysceneitraces outs/extra2/extra2.json -o out/uniformed_points.jpg -s 256 -r 720